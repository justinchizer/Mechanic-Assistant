...
var bot = new botbuilder.UniversalBot(chatConnector);
...
bot.dialog('/', [
    ...
    function (session) {
        ...
        botbuilder.Prompts.choice(session, 'Choose a demo', DemoNames);
...
bot.dialog('buttons', [
    ...
    function (session) {
        ...
        botbuilder.Prompts.choice(session, "Choose a sandwich:", ["Tuna", "Roast Beef", "Veggie Special"]);
